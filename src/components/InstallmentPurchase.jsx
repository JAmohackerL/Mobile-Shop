        ...
        <div className="w-full md:w-1/2 space-y-8 text-center md:text-right z-10">
          ...
          <ul className="space-y-8">
            {[{
              ...
              <li
                key={idx}
                className="flex items-center gap-6 bg-white shadow-xl rounded-2xl p-6 hover:shadow-2xl transition-shadow duration-300"
              >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="mt-10 px-10 py-4 bg-green-600 text-white font-bold rounded-full shadow-xl hover:bg-green-700 transition-all duration-300"
          >
            محاسبه اقساط
          </motion.button>
        </div>
