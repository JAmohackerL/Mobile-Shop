    ...
    <footer className="bg-green-50 py-12 border-t border-green-200">
      <div className="container mx-auto px-4 max-w-7xl">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-sm text-gray-800">
          {/* درباره ما */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-black">درباره ما</h3>
          ...
          {/* تماس با ما */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-black">تماس با ما</h3>
            <ul className="space-y-2 text-xs text-green-900">
              ...
              <li>
                ...
                <span className="font-bold text-black">۰۲۱۹۱۲۳۴۵۶۷</span>
              </li>
            </ul>
          </div>
          ...
          {/* لینک‌های مفید */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-black">راهنمای خرید از فون پال</h3>
          ...
          {/* مجوزها */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-black">مجوزها</h3>
